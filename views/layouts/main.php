    ...
    <div class="row">
        <div class="span3 bs-docs-sidebar hidden-xs">
            <ul class="nav nav-list bs-docs-sidenav affix">
                ...
                <li><img src="/img/borderMain.png"><a href="#navbar">наши партнеры</a></li>
                ...
                <li><img src="/img/borderMain.png"><a href="#thumbnails">калькулятор</a></li>
                ...
                <li> <a href="#" class="btn-ZZ">заказать звонок</a></li>
